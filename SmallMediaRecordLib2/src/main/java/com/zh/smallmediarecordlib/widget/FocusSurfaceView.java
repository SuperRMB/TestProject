package com.zh.smallmediarecordlib.widget;
...
import com.zh.smallmediarecordlib.R;
...
public class FocusSurfaceView extends SurfaceView {
     ...
     * 设置触摸对焦
     */
    public void setTouchFocus(Camera mCamera) {
                ...
                try {
                    ...
                    if (mCamera != null) {
                        ...
                        if (focusModes != null && focusModes.contains(Camera.Parameters.FOCUS_MODE_AUTO)) {
                            focusOnTouch((int) event.getRawX(), (int) event.getRawY(), mCamera);
                            addFocusToWindow();
                        }
                    }
                }catch (Exception e){
